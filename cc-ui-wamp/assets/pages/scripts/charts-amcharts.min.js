...
{date:"2012-01-13",townName:"Salt Lake City",townSize:12,distance:425,duration:670,latitude:40.75,dashLength:8,alpha:.4},
...
{
	var u=a[n].value;u<i&&(i=u),u>d&&(d=u)
}
AmCharts.ready(function()
{
	AmCharts.theme=AmCharts.themes.dark,
	t=new AmCharts.AmMap,
	t.pathToImages=App.getGlobalPluginsPath()+"amcharts/ammap/images/",
	t.fontFamily="Open Sans",
	t.fontSize="13",
	t.color="#888",
	t.addTitle("Population of the World in 2011",14),
	t.addTitle("source: Gapminder",11),
	t.areasSettings={unlistedAreasColor:"#000000",unlistedAreasAlpha:.1},
	...
	{
		var r=a[u],c=r.value,s=(c-i)/(d-i)*(o-l)+l;s<l&&(s=l);
		var g=r.code;
		n.images.push(
			{
				type:"circle",
